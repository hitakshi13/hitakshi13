...
```ts
const hitakshi = {
  title: "Full Stack Developer | 4th-Year CS Student",
  university: "PCET PCCOER, Pune",
  batch: "2023 – 2027",
  stack: [
    "React.js", "Next.js", "Node.js", "Express.js",
    "MongoDB", "TypeScript", "Firebase", "Supabase",
  ],
  aiTools: ["Gemini AI", "OpenAI GPT-4", "ElevenLabs", "Claude API"],
  launchedProjects: [
    "PrepWise", "Converso", "WanderLust",
    "Zerodha MERN Stock Trading Clone",
  ],
  internships: ["Maxgen Technologies", "SkillCraft Technology"],
};
```
...
| Layer | Technology |
|---|---|
| Core Stack | Next.js, TypeScript, Firebase |
| AI | Gemini AI |

**Code:** [github.com/hitakshi13/ai_mock_interviews](https://github.com/hitakshi13/ai_mock_interviews)
...
| Layer | Technology |
|---|---|
| Core Stack | Next.js, Supabase |
| AI | OpenAI GPT-4, ElevenLabs |

**Code:** [github.com/hitakshi13/saas-app](https://github.com/hitakshi13/saas-app)
...
**Code:** [github.com/hitakshi13/wanderlust](https://github.com/hitakshi13/wanderlust)
...
**Code:** [github.com/hitakshi13/stock-app](https://github.com/hitakshi13/stock-app)
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/hitakshikharag/)
